<h2><a href="https://leetcode.com/problems/time-based-key-value-store/description/?envType=study-plan-v2&envId=binary-search">981. Find Right Interval</a></h2><h3>Medium</h3><hr><p>You are given an array of <code>intervals</code>, where <code>intervals[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> and each <code>start<sub>i</sub></code> is <strong>unique</strong>.</p>
