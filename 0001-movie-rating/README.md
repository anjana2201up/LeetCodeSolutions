<h2><a href="https://leetcode.com/problems/trips-and-users/description/?envType=problem-list-v2&envId=db-db4-window-functions-ranking">1. Movie Rating</a></h2><h3>Medium</h3><hr><p>Table: <code>Movies</code></p>
