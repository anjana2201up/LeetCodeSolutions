<h2><a href="https://leetcode.com/problems/maximum-prime-difference/description/?envType=problem-list-v2&envId=dsa-strategy-summit-number-theory">3. The kth Factor of n</a></h2><h3>Medium</h3><hr><p>You are given two positive integers <code>n</code> and <code>k</code>. A factor of an integer <code>n</code> is defined as an integer <code>i</code> where <code>n % i == 0</code>.</p>
